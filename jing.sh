folder=~/MoreData/emulatedM3Tests/tools/csv/0/
no=$1
sudo ip netns exec ns6 ./emulator --server $folder/af${no}s.csv --client $folder/af${no}c.csv --sif veth6-7 --cif veth6-4 --tcip 10.102.104.1 --tsip 10.106.107.2
